  ...
  return (
    <div className="relative text-gray-900">
      ...
      <div className="relative z-10 p-10 bg-white bg-opacity-90 rounded-lg shadow-xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          ...
          <div className="md:w-1/2 md:ml-10">
            <p className="text-lg mb-6">
              LifeSOS is a platform dedicated to protecting tourists from common scams and ensuring a hassle-free travel experience.
            ...
            <p className="text-lg mb-6">
              Additionally, <strong>84.6%</strong> of tourists said they would use a tool like LifeSOS to report scams and notify other travelers, highlighting the importance of such a service in today’s travel ecosystem.
            </p>
          </div>
        </div>
        ...
        {/* What is LifeSOS Section with Image */}
        <div className="my-12">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 text-lg text-center mb-6 md:mb-0">
              <h2 className="text-4xl font-bold text-center mb-6 text-blue-600">What is LifeSOS?</h2>
              <p className="max-w-2xl mx-auto mb-4">
                LifeSOS is a comprehensive travel safety platform designed to help tourists avoid scams by offering tools like cab fare estimation, price checks, and real-time scam alerts. 
              ...
              <p className="max-w-2xl mx-auto">
                By leveraging the latest technology and a growing community of users, LifeSOS provides reliable and trustworthy data to ensure transparency in pricing and services, making your travel experience safer.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-teal-50 shadow-lg rounded-lg p-6 transition duration-300 ease-in-out hover:bg-teal-100 hover:shadow-2xl">
              ...
              <p className="text-teal-800">
                &ldquo;LifeSOS was incredibly helpful during my trip! I avoided being overcharged by taxi drivers thanks to the fare estimator, and I felt safer knowing I could get real-time alerts.&rdquo;
              </p>
            </div>
            <div className="bg-teal-50 shadow-lg rounded-lg p-6 transition duration-300 ease-in-out hover:bg-teal-100 hover:shadow-2xl">
              <h4 className="text-xl font-bold mb-2 text-teal-900">Chris Harris (UK)</h4>
              <p className="text-teal-800">
                &ldquo;This app is a game changer for travelers! It saved me from being scammed at a local market by checking the prices of goods before purchasing.&rdquo;
              </p>
            </div>
            <div className="bg-teal-50 shadow-lg rounded-lg p-6 transition duration-300 ease-in-out hover:bg-teal-100 hover:shadow-2xl">
              <h4 className="text-xl font-bold mb-2 text-teal-900">Victoria (Australia)</h4>
              <p className="text-teal-800">
                &ldquo;I highly recommend LifeSOS. I used it every day during my trip and it helped me avoid overpriced taxis and fake restaurants!&rdquo;
              </p>
            </div>
            <div className="bg-teal-50 shadow-lg rounded-lg p-6 transition duration-300 ease-in-out hover:bg-teal-100 hover:shadow-2xl">
              <h4 className="text-xl font-bold mb-2 text-teal-900">Linda (Poland)</h4>
              <p className="text-teal-800">
                &ldquo;LifeSOS gave me peace of mind while traveling. I felt more informed and less stressed knowing I could rely on accurate fare estimates and warnings from other tourists.&rdquo;
              </p>
            </div>
          </div>
        </div>
