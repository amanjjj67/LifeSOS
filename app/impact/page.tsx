    ...
    <div className="bg-gradient-to-b from-teal-100 via-white to-blue-100 p-12 shadow-xl">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-20">
        ...
        <div className="md:w-1/2 md:ml-10">
          ...
          <p className="text-lg mb-6 text-gray-700 leading-relaxed font-medium">
            At LifeSOS, we are committed to protecting tourists from scams and overpricing. By offering innovative solutions like real-time scam alerts, cab fare estimations, and price checks, we ensure that tourists can explore new destinations with confidence.
          </p>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 md:mr-10">
          ...
          <p className="text-lg mb-6 text-gray-700 leading-relaxed font-medium">
            LifeSOS plays a crucial role in ensuring safe and scam-free travel experiences for tourists worldwide. By leveraging real-time information and community-driven alerts, we help travelers navigate new cities without fear of being taken advantage of.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed font-medium">
